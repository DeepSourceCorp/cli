...
func setDummyAnalyzerTransformerData() {
	...
	configdata.AnalyzersData.AnalyzerShortcodes = []string{"python", "test-coverage"}
	configdata.AnalyzersData.AnalyzersMeta = []string{`{
   "type": "object",
   "properties": {
      "max_line_length": {
         "type": "integer",
   ...
   "additionalProperties": false
	...
	analyzersMetaMap["python"] = configdata.AnalyzersData.AnalyzersMeta[0]
	analyzersMetaMap["test-coverage"] = configdata.AnalyzersData.AnalyzersMeta[1]
	configdata.AnalyzersData.AnalyzersMetaMap = analyzersMetaMap

	configdata.TransformersData.TransformerShortcodes = []string{"black", "prettier"}
}
