    ...
    <div class="grid w-full grid-cols-2 border rounded-md min-h-36 border-ink-300">
      ...
      <div class="flex flex-col p-2 px-3 pr-2 space-y-2.5">
        ...
        >
          ...
          <span class="w-2/3 text-sm text-right text-vanilla-400">{{ owner.billingAddress }}</span>
        </div>
...
@Component({
  components: { FormGroup, ZButton, ZRadioGroup, ZRadio, ZIcon, UpdateBillingDetailsModal },
  layout: 'dashboard'
})
