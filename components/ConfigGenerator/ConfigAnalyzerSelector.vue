<template>
  <div class="w-full space-y-2">
    ...
    <div v-else class="flex h-64 items-center rounded-sm border border-slate-400">
      <div class="font-base mx-auto max-w-md space-y-4 text-center font-medium">
        <p>
...
export default class ConfigAnalyzerSelector extends Vue {
