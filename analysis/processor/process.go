...
// ConfigureProcessors struct contains the data needed to process the analysis results.
type ConfigureProcessors struct {
...
func (p *ConfigureProcessors) ProcessAnalyzerReport() types.AnalysisResult {
