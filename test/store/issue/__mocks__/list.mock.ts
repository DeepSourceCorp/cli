  ...
  "edges": [
    ...
    },
    {
      "node": {
        ...
        "shortcode": "PYL-W0223",
        "description": "The abstract method which raises `NotImplementedError` is not overridden in the concrete class. This can result in unintended behavior.",
        "occurrenceCount": 6,
    ...
    },
    {
      "node": {
        ...
        "description": "Version pinning forces the build to retrieve a particular version regardless of what’s in the cache. This technique can also reduce failures due to unanticipated changes in required packages.\nYou can read more about it [here](https://docs.docker.com/develop/develop-images/dockerfile_best-practices/#apt-get)\n\nProblematic code:\n\n```dockerfile\nFROM busybox\nRUN apt-get install python\n```\n\nCorrect code:\n\n```dockerfile\nFROM busybox\nRUN apt-get install python=2.7\n```",
        "occurrenceCount": 2,
        "createdAt": "2020-04-09T18:39:18.395080+00:00",
        "analyzerName": "Dockerfile",
        "analyzerLogo": "https://s3.us-east-1.amazonaws.com/local-asgard-static/analyzer_logos/docker.svg",
        "seenIn": "Dockerfile",
