...
import RepositoryWidgetsGQLQuery from '~/apollo/queries/repository/repositoryWidgets.gql'
import RepositorySettingsGeneralGQLQuery from '~/apollo/queries/repository/repositorySettings/repositorySettingsGeneral.gql'
import RepositorySettingsSshGQLQuery from '~/apollo/queries/repository/repositorySettings/repositorySettingsSsh.gql'
import RepositorySettingsIgnoreRulesGQLQuery from '~/apollo/queries/repository/repositorySettings/repositorySettingsIgnoreRules.gql'
import RepositorySettingsManageAccessGQLQuery from '~/apollo/queries/repository/repositorySettings/repositorySettingsManageAccess.gql'
import {
  Repository
} from '~/types/types'
import {
