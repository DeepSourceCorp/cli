...
import RepositoryRunGQLQuery from '~/apollo/queries/check/checkDetail.gql'
import RunConcreteIssueListGQLQuery from '~/apollo/queries/check/checkConcreteIssueList.gql'
import RunAutofixableIssuesGQLQuery from '~/apollo/queries/check/checkAutofixableIssues.gql'
import {
  PageInfo,
  Maybe,
  IssueEdge,
